...
physicians <- read.csv("data_sources/physician per 1000/API_SH.MED.PHYS.ZS_DS2_en_csv_v2_16031.csv")
...
write.csv(physicians_subset, "working_data/physicians_subset.csv", row.names = FALSE)


# Clean up environment by removing raw datasets
rm(gdp_data, health_expenditure, hospital_beds, exp_gdp_ratio, poultry_prod, H5N1_incidence, physicians)
